...
export class Demo extends Phaser.Scene {
	...
	create() {
		...
		labels.forEach(function (label: any) {
			...
			var click = scene.rexUI.add.click(label.getElement("icon")).on("click", function () {
...
var createPanel = function (scene: Demo, data: any) {
...
var createHeader = function (scene: Demo, data: any) {
...
var createTable = function (scene: Demo, data: any, key: any, rows: any) {
...
var createIcon = function (scene: Demo, item: any, iconWidth: any, iconHeight: any) {
